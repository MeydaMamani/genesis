...
class e(models.Model):
    ...
    cod_ipress = models.CharField(max_length=10, blank=True, null=True)
    cod_ugipress = models.CharField(max_length=10, blank=True, null=True)
    tparto = models.CharField(max_length=3, blank=True, null=True)
    complicacion = models.CharField(max_length=8, blank=True, null=True)
    partos = models.CharField(max_length=8, blank=True, null=True)
    t_nac = models.CharField(max_length=8, blank=True, null=True)
    vivos = models.CharField(max_length=8, blank=True, null=True)
    muertos = models.CharField(max_length=8, blank=True, null=True)
    cod_dist2 = models.CharField(max_length=10, blank=True, null=True)
...
class f(models.Model):
    ...
    gedad = models.CharField(max_length=8, blank=True, null=True)
    eventos = models.CharField(max_length=8, blank=True, null=True)
    total = models.CharField(max_length=8, blank=True, null=True)
    cod_dist2 = models.CharField(max_length=10, blank=True, null=True)
