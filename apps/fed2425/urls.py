...
urlpatterns = [
    ...
    path('si03/', login_required(SI03View.as_view()), name='si03'),
    path('si03/list/', ListSI03.as_view(), name='si03_list'),
    path('si03/filterDist/', views.DistrictSI03View.as_view(), name='filter_dist'),
    path('si03/print/', PrintSI03.as_view(), name='si03_print'),
